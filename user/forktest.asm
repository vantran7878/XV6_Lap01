...
forktest(void)
{
  ...
  34:	44050513          	addi	a0,a0,1088 # 470 <pgaccess+0xe>
  ...
  56:	46e50513          	addi	a0,a0,1134 # 4c0 <pgaccess+0x5e>
  ...
  6c:	41850513          	addi	a0,a0,1048 # 480 <pgaccess+0x1e>
  ...
  7e:	41e50513          	addi	a0,a0,1054 # 498 <pgaccess+0x36>
  ...
  ae:	40650513          	addi	a0,a0,1030 # 4b0 <pgaccess+0x4e>
...
stat(const char *n, struct stat *st)
{
 ...
 24e:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 250:	85ca                	mv	a1,s2
 252:	192000ef          	jal	3e4 <fstat>
 256:	892a                	mv	s2,a0
  close(fd);
 258:	8526                	mv	a0,s1
 25a:	15a000ef          	jal	3b4 <close>
  return r;
 25e:	64a2                	ld	s1,8(sp)
}
 260:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 376:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3fff045>
